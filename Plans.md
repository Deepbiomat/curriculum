...
|------|---------|-----|---------|--------|
| 1.1.1 | Vector spaces, bases, change of basis (notes) | notes/L1-foundations/linear-algebra.md exists | - | cc:完了 |
| 1.1.2 | Linear transformations, rank, nullity, four fundamental subspaces (notes) | notes content covers four subspaces with examples | 1.1.1 | cc:完了 |
| 1.1.3 | Orthogonality: projections, Gram-Schmidt, QR decomposition (notes) | Gram-Schmidt algorithm derived, QR explained | 1.1.2 | cc:完了 |
| 1.1.4 | Eigendecomposition + SVD (notes + exercise) | exercises/L1/eigendecomposition.md works without errors | 1.1.3 | cc:完了 |
| 1.1.5 | Matrix calculus (notes + 5 derived gradients exercise) | 5 gradients correctly derived in exercise | 1.1.4 | cc:完了 |
| 1.1.6 | Tensor notation: index notation, Einstein summation (notes) | notes/L1-foundations/tensor-notation.md complete | 1.1.5 | cc:完了 |
| 1.1.7 | Derive backpropagation from scratch (exercise) | exercises/L1/backprop-derivation.md runs, derivation complete | 1.1.6 | cc:完了 |
| 1.2.1 | Conditional probability + Bayes (notes) | notes/L1-foundations/probability.md covers both | - | cc:完了 |
| 1.2.2 | MLE vs MAP (notes + worked example) | worked example in notes demonstrates both | 1.2.1 | cc:完了 |
| 1.2.3 | Common distributions (notes + sampling exercise) | exercises/L1/sampling.md runs, distributions sampled | 1.2.2 | cc:完了 |

## Phase 2: L1 ODEs & Biochemistry

| Task | Content | DoD | Depends | Status |
|------|---------|-----|---------|--------|
| 1.3.1 | Linear ODEs, separation of variables (notes) [tdd:skip:notes-only] | notes/L1-foundations/odes.md exists, separation of variables explained with examples | Phase 1 | cc:TODO |
